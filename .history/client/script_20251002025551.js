...
function connectWebSocket(){
    ...
    socket.onmessage = function(event){
        ...
        addMessage(`Server: ${event.data}`, 'server-message'); // fixed class placement
    };
...
function sendMessage(){
    const message = messageInput.value.trim(); // fixed: was ariaValueMax
    ...
    if (socket && socket.readyState === WebSocket.OPEN){
        ...
        socket.send(message); // fixed: was sendMessage()
        addMessage(`You: ${message}`, 'client-message'); // fixed class placement
        messageInput.value = '';
    }else {
